...
export default function SecurityShieldBadge({ state, className }: SecurityShieldBadgeProps) {
  ...
  const config = {
    ...
    medium: {
      ...
      className: 'text-amber-700 border-amber-300 bg-amber-50 dark:text-amber-300 dark:border-amber-700 dark:bg-amber-950/30',
    },
    high: {
      Icon: ShieldCheck,
      label: t('high'),
      description: t('highDescription'),
      className: 'text-emerald-700 border-emerald-400 bg-emerald-50 dark:text-emerald-300 dark:border-emerald-700 dark:bg-emerald-950/30',
    },
  } as const;
