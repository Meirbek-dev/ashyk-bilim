...
export default function ReadinessPanel({ isReady, issues, isLoading }: ReadinessPanelProps) {
  ...
  if (isReady) {
    return (
      <Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950">
        ...
        <AlertTitle className="text-green-800 dark:text-green-200">{t('readyToPublish')}</AlertTitle>
      </Alert>
    );
  }
  ...
  return (
    <Alert className="border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950">
      ...
      <AlertTitle className="text-red-800 dark:text-red-200">{t('needsWork')}</AlertTitle>
