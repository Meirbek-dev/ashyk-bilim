...
export interface paths {
    ...
    "/api/v1/assessments/{assessment_uuid}/code-challenge/validate": {
         ...
         * @description Validate reference solutions for all configured languages against the test suite.
         */
    ...
    "/api/v1/assessments/{assessment_uuid}/items/{item_uuid}/runs/{run_uuid}": {
         ...
         * @description Fetch a previously-created student-safe code run.
         */
