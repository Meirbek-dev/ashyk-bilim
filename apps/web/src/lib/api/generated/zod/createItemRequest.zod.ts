...
export const CreateItemRequest = zod.object({
  body: zod
    .union([
      zod
        .object({
...
export type CreateItemRequest = zod.input<typeof CreateItemRequest>
export type CreateItemRequestOutput = zod.output<typeof CreateItemRequest>
