...
export const AwardResponse = zod.object({
...
export type AwardResponse = zod.input<typeof AwardResponse>
export type AwardResponseOutput = zod.output<typeof AwardResponse>
