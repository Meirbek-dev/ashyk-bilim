...
export const TeacherOverviewParams = zod.object({
...
export type TeacherOverviewParams = zod.input<typeof TeacherOverviewParams>
export type TeacherOverviewParamsOutput = zod.output<typeof TeacherOverviewParams>
