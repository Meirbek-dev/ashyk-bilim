...
export const CourseDetailParams = zod.object({
...
export type CourseDetailParams = zod.input<typeof CourseDetailParams>
export type CourseDetailParamsOutput = zod.output<typeof CourseDetailParams>
