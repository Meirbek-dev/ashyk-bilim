...
export const AdminOverviewParams = zod.object({
...
export type AdminOverviewParams = zod.input<typeof AdminOverviewParams>
export type AdminOverviewParamsOutput = zod.output<typeof AdminOverviewParams>
