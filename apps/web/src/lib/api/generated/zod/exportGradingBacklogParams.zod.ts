...
export const ExportGradingBacklogParams = zod.object({
...
export type ExportGradingBacklogParams = zod.input<typeof ExportGradingBacklogParams>
export type ExportGradingBacklogParamsOutput = zod.output<typeof ExportGradingBacklogParams>
