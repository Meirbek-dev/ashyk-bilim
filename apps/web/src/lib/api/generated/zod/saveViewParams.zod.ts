...
export const SaveViewParams = zod.object({
...
export type SaveViewParams = zod.input<typeof SaveViewParams>
export type SaveViewParamsOutput = zod.output<typeof SaveViewParams>
