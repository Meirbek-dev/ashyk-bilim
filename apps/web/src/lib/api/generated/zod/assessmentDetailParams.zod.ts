...
export const AssessmentDetailParams = zod.object({
...
export type AssessmentDetailParams = zod.input<typeof AssessmentDetailParams>
export type AssessmentDetailParamsOutput = zod.output<typeof AssessmentDetailParams>
