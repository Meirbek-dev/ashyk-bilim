...
export const CreateFileSubmissionBody = zod
  .object({
...
export type CreateFileSubmissionBody = zod.input<typeof CreateFileSubmissionBody>
export type CreateFileSubmissionBodyOutput = zod.output<typeof CreateFileSubmissionBody>
