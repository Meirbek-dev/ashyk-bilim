...
export const AtRiskLearnersParams = zod.object({
...
export type AtRiskLearnersParams = zod.input<typeof AtRiskLearnersParams>
export type AtRiskLearnersParamsOutput = zod.output<typeof AtRiskLearnersParams>
