...
export const CourseListParams = zod.object({
...
export type CourseListParams = zod.input<typeof CourseListParams>
export type CourseListParamsOutput = zod.output<typeof CourseListParams>
