...
export const UpdateOverrideBody = zod
  .object({
...
export type UpdateOverrideBody = zod.input<typeof UpdateOverrideBody>
export type UpdateOverrideBodyOutput = zod.output<typeof UpdateOverrideBody>
