...
export const AssessmentListParams = zod.object({
...
export type AssessmentListParams = zod.input<typeof AssessmentListParams>
export type AssessmentListParamsOutput = zod.output<typeof AssessmentListParams>
