...
export const ExportAtRiskParams = zod.object({
...
export type ExportAtRiskParams = zod.input<typeof ExportAtRiskParams>
export type ExportAtRiskParamsOutput = zod.output<typeof ExportAtRiskParams>
