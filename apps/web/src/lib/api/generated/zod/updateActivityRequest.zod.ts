...
export const UpdateActivityRequest = zod.object({
...
export type UpdateActivityRequest = zod.input<typeof UpdateActivityRequest>
export type UpdateActivityRequestOutput = zod.output<typeof UpdateActivityRequest>
