...
}: GetRoleColumnsParams): ColumnDef<RoleWithPermissions>[] {
  return [
    {
...
export function getAuditColumns(t: AppTranslator): ColumnDef<RoleAuditEvent>[] {
  return [
    {
...
export function getPermissionColumns(t: AppTranslator): ColumnDef<Permission>[] {
  return [
    {
