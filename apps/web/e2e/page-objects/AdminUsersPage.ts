...
export class AdminUsersPage {
  ...
  public constructor(page: Page) {
    ...
    this.confirmAssignButton = page.getByRole('button', { name: /assign role|confirm|save/i });
  ...
  public async assignRole(userEmail: string, roleName: string): Promise<void> {
    ...
    await expect(this.page.locator('[data-sonner-toast]').first()).toBeVisible({ timeout: 10_000 });
  }
}
