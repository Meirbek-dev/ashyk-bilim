...
async def create_image_block(request: Request, image_file: UploadFile, activity_uuid: str, db_session: Session):
...
async def get_image_block(request: Request, block_uuid: str, current_user: PublicUser, db_session: Session):
