...
class ExamBase(SQLModelStrictBaseModel):
    ...
    # Compatibility storage for older exam routes. Canonical settings live on
    # Activity.settings and are read/written through src.services.assessments.settings.
